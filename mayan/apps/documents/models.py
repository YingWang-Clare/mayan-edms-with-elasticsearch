    ...
    def new_document(self, file_object, label=None, description=None, language=None, _user=None):
        try:
            with transaction.atomic():
                ...
                logger.info('Document Type, call save(), call new_version().')
...
class Document(models.Model):
    ...
    * uuid - UUID of a document, universally Unique ID. An unique identifier
    ...
    def save(self, *args, **kwargs):
        ...
        super(Document, self).save(*args, **kwargs) # real save happens here
    ...
    def new_version(self, file_object, comment=None, _user=None):
        ...
        logger.info('New file version %s', File(file_object))
    ...
    def save_to_file(self, *args, **kwargs):
        logger.info('Document, call save_to_file()')
...
class DocumentVersion(models.Model):
    ...
    * checksum - A hash/checkdigit/fingerprint generated from the document's
    ...
    def save(self, *args, **kwargs):
        ...
        logger.info('Document Version, call save()')
    ...
    def save_to_file(self, filepath, buffer_size=1024 * 1024):
        ...
        logger.info('Document Version, call save_to_file()')
...
class DocumentPage(models.Model):
    ...
    document_version = models.ForeignKey(
        DocumentVersion, on_delete=models.CASCADE, related_name='pages', # many to many field
        verbose_name=_('Document version')
    )
